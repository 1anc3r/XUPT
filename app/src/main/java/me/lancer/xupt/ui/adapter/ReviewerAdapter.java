...
import me.lancer.xupt.ui.activity.ReviewerDetailActivity;

public class ReviewerAdapter extends RecyclerView.Adapter<ReviewerAdapter.ViewHolder> {

    private List<BookReviewer> reviewerList;
    private RequestQueue mQueue;

    public ReviewerAdapter(Context context, List<BookReviewer> reviewerList) {
