...
public class LoginCardActivity extends PresenterActivity<LoginCardPresenter> implements ILoginCardView {
        ...
        public void handleMessage(Message msg) {
            if (msg.obj != null) {
                ...
                if (log.equals("show")) {
                    ...
                    intent.setClass(LoginCardActivity.this, MainActivity.class);
            ...
            if (v == btnLogin) {
                ...
                if (networkDiagnosis.checkNetwork(getApplication())) {
                    if (cetNumber.getText().toString().equals("")) {
                        ...
                        editor.apply();
                        if (!networkDiagnosis.checkNetwork(LoginCardActivity.this)) {
