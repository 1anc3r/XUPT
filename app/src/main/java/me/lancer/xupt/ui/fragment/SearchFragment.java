...
import me.lancer.xupt.ui.adapter.ReviewerAdapter;
...
public class SearchFragment extends PresenterFragment<BookPresenter> implements IBookView {
    ...
    List<BookReviewer> reviewerList = new ArrayList<>();
